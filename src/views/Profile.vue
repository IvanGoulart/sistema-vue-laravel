        ...
        <div class="card-body p-3">
          <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
              <div class="h-100">
                <h5 class="mb-1">{{ showMenu.nome }}</h5>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <argon-input type="email" v-model="formData.email" :value="formData.email" />
                  </div>
                  <div class="col-md-6">
                    <label for="example-text-input" class="form-control-label">Nome</label>
                    <argon-input type="text" :value="formData.name" v-model="formData.name" />
                  </div>
                  <div class="col-md-6">
                    <label for="example-text-input" class="form-control-label">Nova senha</label>
                    <argon-input type="password" :value="formData.password" v-model="formData.password" />
                ...
                <div class="col-6 text-end">
                  <argon-button color="danger" variant="gradient" type="submit">
  ...
  methods: {
    async submitForm() {
      try {
        ...
        await this.$store.dispatch("profile/update", this.formData);
